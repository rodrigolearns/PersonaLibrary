...
// Test the function
const userQuery = "What is AD?";
const activePersonas = ["Eric Reits"]; // Replace with the names of the active personas
translateQuery(userQuery, activePersonas)
  .then(translatedQueries => console.log(translatedQueries))
